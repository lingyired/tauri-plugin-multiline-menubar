...
`multiline-menubar:allow-create`
...
`multiline-menubar:deny-is-visible`
...
`multiline-menubar:allow-remove-menu`

</td>
<td>

Enables the remove_menu command without any pre-configured scope.
...
`multiline-menubar:deny-remove-menu`
...
`multiline-menubar:allow-set-bold`
...
`multiline-menubar:deny-set-bold`
...
`multiline-menubar:deny-set-font-sizes`
...
`multiline-menubar:deny-set-menu`
...
`multiline-menubar:allow-set-text`
...
`multiline-menubar:deny-set-text`
